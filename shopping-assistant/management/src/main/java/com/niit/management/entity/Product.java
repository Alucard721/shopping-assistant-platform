...
public class Product {
	private int id;
	//校验字段是否为空
	//指定校验组,当InvalidProductGroup被激活时启用校验,返回信息
	@NotBlank(message = "商品id不能为空",groups = InvalidProductGroup.class)
	private String productId;
	@NotBlank(message = "商品名称不能为空",groups = InvalidProductGroup.class)
	private String productName;
	@NotBlank(message = "商品价格不能为空",groups = InvalidProductGroup.class)
	private String price;
	private String categoryName;
	@NotBlank(message = "销量不能为空",groups = InvalidProductGroup.class)
	@Pattern(regexp="^[0-9]*(.0)?$" ,message = "销量格式不合法",groups = InvalidProductGroup.class)
	...
	@NotNull(message = "店铺描述不能为空",groups = InvalidProductGroup.class)
	@DecimalMin(value = "1.0",message = "店铺描述格式不合法",groups = InvalidProductGroup.class)
	private Double shopdsrMs;
	@NotNull(message = "店铺服务不能为空",groups = InvalidProductGroup.class)
	@DecimalMin(value = "1.0",message = "店铺服务格式不合法",groups = InvalidProductGroup.class)
	private Double shopdsrFw;
	@NotNull(message = "店铺物流不能为空",groups = InvalidProductGroup.class)
	@DecimalMin(value = "1.0",message = "店铺物流格式不合法",groups = InvalidProductGroup.class)
	private Double shopdsrWl;
	@NotBlank(message = "商品地址不能为空",groups = InvalidProductGroup.class)
	private String productUrl;
	private String productDetail;
	@NotNull(message = "商品得分不能为空",groups = InvalidProductGroup.class)
	private Double productScore;
	private String recommendedReason;
	private String updateTime;
	@NotNull(message = "历史价格不能为空",groups = InvalidProductGroup.class)
